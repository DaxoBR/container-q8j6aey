...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-q8j6aey.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-q8j6aey.containers.anotherwebservice.com/
...
```
git clone git@github.com:DaxoBR/container-q8j6aey.git
cd container-q8j6aey
```
...
```
docker attach container-q8j6aey
```
